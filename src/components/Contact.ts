  ...
  init(): void {
    ...
    if (contactForm) {
      contactForm.addEventListener('submit', async (e: Event) => {
        ...
        const emailInput = document.getElementById('senderEmail') as HTMLInputElement | null;
        const subjectInput = document.getElementById('inquirySubject') as HTMLInputElement | null;
        const messageInput = document.getElementById('messageBody') as HTMLTextAreaElement | null;
